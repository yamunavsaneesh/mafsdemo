...
class Downloadcategory_model extends CI_Model
{
    public function __construct()
    {
        parent::__construct();
        $this->lang_table_name = 'languages';
        $this->table_name = 'download_category';
        $this->desc_table_name = 'download_category_desc';
        $this->primary_key = 'id';
        $this->foreign_key = 'download_category_id';
    }
