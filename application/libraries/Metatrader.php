...
class Metatrader
{
    ...
    public function MQ_Query($query, $cacheDir = T_CACHEDIR, $cacheTime = T_CACHETIME, $cacheDirPrefix = '')
    {
        $ret = '';
    ...
    //| Clear cache                                                      |
    //+------------------------------------------------------------------+
    public function MQ_ClearCache($dirName)
    {
        ...
        foreach ($list as $fileName) {
            ...
            if (is_dir($fileName)) {
                ...
                if ($MQ_CLEAR_NUMBER >= T_CLEAR_DELNUMBER) {
                    return;
                }
