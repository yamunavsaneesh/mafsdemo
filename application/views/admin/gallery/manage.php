...
?> 
<div class="full_w"> 
  <div class="h_title">Manage Gallery</div> 
  <?php echo $this->session->flashdata('message'); ?> <?php echo form_open_multipart('admin/gallery/lists/'.$return, array('id' => 'galleryform')); ?> 
  ...
  <ul class="image-list"> 
    ...
    <li> 
      ...
      <?php if (file_exists('public/uploads/gallery/'.$image['image'])){ ?> 
      <a href="<?php echo base_url('public/uploads/gallery/'.$image['image']); ?>" class="lightbox" rel="images"> 
      <div class="gallery-img" style="background:url('<?php echo base_url('public/uploads/gallery/'.$image['image']); ?>') no-repeat center"></div> 
      </a> 
      <div align="center"> 
        <input id="sort_order" name="sort_order[<?php echo $image['id']; ?>]" type="text" class="small" value="<?php echo $image['sort_order']; ?>" /> 
      </div> 
      <?php } ?> 
    </li> 
