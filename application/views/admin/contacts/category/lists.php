...
?> 
<div class="full_w">
    <div class="h_title">Manage Contact Category - List</div>
    <?php echo $this->session->flashdata('message'); ?> <?php echo form_open('admin/contacts/categoryactions'); ?>
    <div class="entry">
...
foreach ($contacts as $contact): ?>
            <tr>
                ...
                <td><a href="<?php echo site_url('admin/contacts/editcategory/' . $contact['id'] . '/' . $return); ?>"
                        class="table-icon edit" title="Edit"></a> <a
                        href="<?php echo site_url('admin/contacts/deletecategory/' . $contact['id'] . '/' . $return); ?>"
    ...
    <div class="entry">
        ...
        <div class="sep"></div>
        <a class="button add" href="<?php echo site_url('admin/contacts/addcategory'); ?>">Add New Contact Category</a>
    </div> 
</div>