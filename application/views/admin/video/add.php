<div class="full_w"> 
	<div class="h_title">Add New video Gallery</div>	 
	<?php echo form_open_multipart('admin/video/add/'.$this->uri->segment(4)); ?> 
		<div class="element"> 
        ...
        <div class="element"> 
			<label for="title">Video URL (<?php echo $this->languagesarr[$this->session->userdata('admin_language')]?>)<?php if(form_error('video')){ $err=' err'; echo form_error('video'); } else  $err='';  ?></label> 
			<input id="video" name="video" type="text" class="text<?php echo $err; ?>" value="<?php echo set_value('video'); ?>" /> 
		</div>	 
		<div class="element"> 
		...
		<div class="entry"> 
			<button type="submit" class="add">Save</button><a class="button cancel" href="<?php echo site_url('admin/video/lists'); ?>">Cancel</a> 
		</div> 
	<?php echo form_close(); ?> 
</div>