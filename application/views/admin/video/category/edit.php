<div class="full_w"> 
  <div class="h_title">Edit Video Gallery Category</div> 
  <?php echo form_open_multipart('admin/video/editcategory/'.$gallery->id.'/'.$return); ?> 
  ...
  <div class="entry"> 
    ...
    <a class="button cancel" href="<?php echo site_url('admin/video/categories/'.$return); ?>">Cancel</a> </div> 
  <?php echo form_close(); ?>  
</div> 
