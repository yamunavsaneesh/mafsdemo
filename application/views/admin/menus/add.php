<div class="full_w"> 
	<div class="h_title">Add New Menu</div>	 
	<?php echo form_open('admin/menus/add'); ?> 
		<div class="element"> 
		...
		<div class="entry"> 
			<button type="submit" class="add">Save</button><a class="button cancel" href="<?php echo site_url('admin/menus/lists'); ?>">Cancel</a> 
		</div> 
	<?php echo form_close(); ?> 
</div>