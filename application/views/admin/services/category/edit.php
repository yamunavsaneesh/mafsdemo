...
<div class="full_w"> 
  <div class="h_title">Edit Service Category</div> 
  <?php echo form_open_multipart('admin/services/editcategory/'.$content->id.'/'.$return); ?> 
  ...
  <div class="element"> 
    <label for="image">Pdf (<?php echo $this->languagesarr[$this->session->userdata('admin_language')]?>) - <?php echo $content->pdf; ?></label> 
  ...
  <div class="entry"> 
    ...
    <a class="button cancel" href="<?php echo site_url('admin/services/categories/'.$return); ?>">Cancel</a> </div> 
