<div class="full_w"> 
  ...
  <div class="element"> 
    ...
    <select name="category_id" id="category_id" class="text" onchange="show(this.value)"> 
  ...
  <div class="element"> 
    <label for="image2">Image for details page (<?php echo $this->languagesarr[$this->session->userdata('admin_language')]?>)</label> 
  ...
  <div class="element"> 
    <label for="attachment">Content PDF (<?php echo $this->languagesarr[$this->session->userdata('admin_language')]?>)</label> 
