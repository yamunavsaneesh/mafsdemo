<div class="full_w"> 
  <div class="h_title">Add New News Category</div> 
  <?php echo form_open('admin/news/addcategory'); ?> 
  <div class="element"> 
  ...
  <div class="entry"> 
    ...
    <a class="button cancel" href="<?php echo site_url('admin/news/categories'); ?>">Cancel</a> </div> 
